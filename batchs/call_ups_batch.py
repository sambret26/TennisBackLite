...
class CallUpsBatchContext:
    def __init__(self):
        self.categories = category_repository.get_all()
        self.players_by_crm_id_map = player_repository.get_all_by_crm_id_map()
        self.matches_by_id_map = match_repository.get_by_id_map()
        self.call_ups_by_id_map = call_up_repository.get_by_id_map()
