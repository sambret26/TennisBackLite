...
class Team(db.Model):
    ...
    def to_mini_dict(self):
        return {
            ...
            "ranking": self.ranking,
            "player1": self.player1.to_mini_dict(),
            "player2": self.player2.to_mini_dict()
        }

    def get_full_name(self):
        return f"{self.player1.last_name.upper()}/{self.player2.last_name.upper()}"

    def get_full_name_with_ranking(self):
        return f"{self.get_full_name()} ({self.ranking})"
